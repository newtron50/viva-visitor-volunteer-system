...
//echo '<br><center><a href="./functions/print.php" target="_blank">Create a printable report</a><br></center>';
...
$x=0;
echo '<div style="display: inline-block;""><br><br>';
echo '<br><br>';
...
<body>
 ...
 <div id='barchart' style='width: 400px; height:600px;'></div>";
echo  '<br>';
echo '</div>';
?>
