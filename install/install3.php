...
echo '<p>What Guest functions do you want for this program:   <span class="tooltip" style="position:relative;top:0px;left:8px;z-index:5;"><img src="../images/Help.png"alt="question mark" height="15" width="15"><span class="tooltiptext"> You can limit the menus & operation depending on the needs of your organization<br></span></span><br><br><input type="radio" name="fc" value="1"> Visitors Only (No Volunteers)<br><input type="radio" name="fc" value="2"> Volunteers Only (no Visitors)<br><input type="radio" name="fc" value="3"> VISITORS AND VOLUNTEERS</p>';
